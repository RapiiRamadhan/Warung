    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item {{ request()->routeIs('pelanggans.index') ? 'active' : '' }}">
                    <a href="{{ route('pelanggans.index') }}" class='sidebar-link'>
                        <i class="bi bi-person-fill"></i>
                        <span>Pelanggan</span>
                    </a>
                </li>                
                <li class="sidebar-item {{ request()->routeIs('orders.index') ? 'active' : '' }}">
